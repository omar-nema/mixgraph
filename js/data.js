...
let filterGeneration = 0; // bumped on every filter change; used to sync modes on switch
let tracksFilterGen = 0;  // filterGeneration when tracks mode last rendered
let cratesFilterGen = 0;  // filterGeneration when crates mode last rendered
